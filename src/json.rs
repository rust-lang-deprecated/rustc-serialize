...
fn spaces(wr: &mut fmt::Writer, n: u32) -> fmt::Result {
...
impl<'a> ::Encoder for Encoder<'a> {
    ...
    fn emit_usize(&mut self, v: usize) -> EncodeResult { write!(self.writer, "{}", v) }
    ...
    fn emit_isize(&mut self, v: isize) -> EncodeResult { write!(self.writer, "{}", v) }
